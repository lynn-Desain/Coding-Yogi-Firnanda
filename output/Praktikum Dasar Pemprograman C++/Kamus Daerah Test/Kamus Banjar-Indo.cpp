...
// Fungsi terjemah kalimat Indonesia ke Banjar (baru)
...
// Fungsi terjemah kalimat Banjar ke Indonesia (baru)
...
int main() {
    ...
    do {
        ...
        std::cout << "1. Terjemah Kata/Frasa Indonesia - Banjar" << std::endl;
        std::cout << "2. Terjemah Kata/Frasa Banjar - Indonesia" << std::endl;
        std::cout << "3. Terjemah Kalimat Indonesia - Banjar" << std::endl;  // Menu baru
        std::cout << "4. Terjemah Kalimat Banjar - Indonesia" << std::endl;  // Menu baru
        std::cout << "5. Ekspor Kamus ke CSV (Edit di Excel)" << std::endl;
        std::cout << "6. Load Ulang dari CSV (Update dari Excel)" << std::endl;
        ...
        switch (pilihan) {
            ...
            case 2:
                ...
                break;
            case 3:
                terjemahKalimatIdKeBanjar(idToBanjar);  // Fungsi baru
                break;
            case 4:
                terjemahKalimatBanjarKeId(banjarToId);  // Fungsi baru
                break;
            case 5:
            ...
            case 7:
                ...
                break;
            default:
                std::cout << "Pilihan tidak valid! Silakan pilih 1-7." << std::endl; 
        }
    } while (pilihan != 7);
